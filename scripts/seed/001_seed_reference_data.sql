...
-- Subscription Tiers
INSERT INTO subscription_tiers_ref (tier_code, tier_name, tier_description, marketing_tagline, base_price, annual_price, display_order, color_hex, is_active) VALUES
('basic', 'Basic Care', 'Essential pet care services', 'Start your journey', 499.00, 4990.00, 1, '#3B82F6', true),
('plus', 'Plus Care', 'Enhanced protection and perks', 'Step up the care', 1999.00, 19990.00, 2, '#8B5CF6', true),
('eternal', 'Eternal Care', 'Premium all-inclusive care', 'The ultimate love', 3999.00, 39990.00, 3, '#F59E0B', true)
